...
def input_numbers():
    ...
    while True:
        ...
        if userInput == '':
            ...
            print(f"Invalid characters \"{find_first_invalid_character(userInput)}\" detected in {userInput}.")
        else:
...
numbers = input_numbers() # Assigns 'numbers' so the below function knows what its parameter is
