...
4. It's generally not a good idea to redefine a variable (e.g. income = int(income)) - it makes it really easy to lose track of exactly what type or value a variable has and opens you up for bugs. It's generally better to do something like
income_input = input("...")
income = int(income_input)

5. Under Income_Tax_Calculations, you check if the number of dependents is greater than 0. However, you don't really need this check. After all, if the number of dependents is 0, then 2000 * dependents_under_6 + 3000 * dependents_over_6 = 0 anyway.
